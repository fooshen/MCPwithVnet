# Part 1: Create and deploy a simple MCP server on Azure Function and testing in Copilot Studio
...
33. You can now proceed to the next guide on [Part 2: Setting up and connecting Power Platform to a Virtual Network](VNET.md).
